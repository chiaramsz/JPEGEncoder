...
public abstract class AbstractHuffmanCoder implements EntropyCoderI {
    ...
    /**
     * last DC coefficients of component Y_COMP, CB_COMP and CR_COMP
     **/
     ...
     *                   be one of YUVImageI.Y_COMP, YUVImageI.CB_COMP or YUVImageI.CR_COMP.
     ...
     * @throws java.io.IOException if a problem occurrs while writing to the output stream
     */
    protected void encodeDifferentialDCValue(int dcValue, int compType, BufferedOutputStream bos) throws IOException {
        ...
        int huffTableIndex = (compType == YUVImageI.Y_COMP ? 0 : 1);
     ...
     * @param bos       the buffered output stream to write the encoded bits into
     * @throws java.io.IOException                if a problem occurrs while writing to the output stream
     * @throws java.lang.IllegalArgumentException if the RUN-LEVEL sequence contains
